...
export default function HospitalsEscalatedAlertsPage() {
  ...
  React.useEffect(() => {
    const fetchEscalated = async () => {
      ...
      try {
        ...
        setEscalatedAlerts(hospitalAlerts.filter(a => a.isEscalated));
      } catch (error) {
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>High-priority alerts requiring immediate hospital coordination and response.</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            <Table>
