...
export default function CommunityEscalatedAlertsPage() {
  ...
  React.useEffect(() => {
    const fetchEscalated = async () => {
      ...
      try {
        ...
        setEscalatedAlerts(communityAlerts.filter(a => a.isEscalated));
      } catch (error) {
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>High-priority community issues requiring immediate attention.</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            <Table>
